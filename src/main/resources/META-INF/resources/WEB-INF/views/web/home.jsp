...
<body>
	...
	<div class="main">
		<div class="container">
          ...
          showuntil: 4000;
          ">
							<strong>Unlimted</strong> Layout Options <em>Fully
								Responsive</em>
						</div>
							...
							<div class="owl-carousel owl-carousel5">
								<div>
									<div class="product-item">
										<div class="pi-img-wrapper">
											<img
												src="${URL}assets/frontend/pages/img/products/model1.jpg"
												class="img-responsive" alt="Berry Lace Dress">
											<div>
												<a
													href="${URL}assets/frontend/pages/img/products/model1.jpg"
													class="btn btn-default fancybox-button">Zoom</a> <a
													href="#product-pop-up"
													class="btn btn-default fancybox-fast-view">View</a>
											</div>
								...
								<div>
									<div class="product-item">
										<div class="pi-img-wrapper">
											<img
												src="${URL}assets/frontend/pages/img/products/model2.jpg"
												class="img-responsive" alt="Berry Lace Dress">
											<div>
												<a
													href="${URL}assets/frontend/pages/img/products/model2.jpg"
													class="btn btn-default fancybox-button">Zoom</a> <a
													href="#product-pop-up"
													class="btn btn-default fancybox-fast-view">View</a>
											</div>
								...
								<div>
									<div class="product-item">
										<div class="pi-img-wrapper">
											<img
												src="${URL}assets/frontend/pages/img/products/model6.jpg"
												class="img-responsive" alt="Berry Lace Dress">
											<div>
												<a
													href="${URL}assets/frontend/pages/img/products/model6.jpg"
													class="btn btn-default fancybox-button">Zoom</a> <a
													href="#product-pop-up"
													class="btn btn-default fancybox-fast-view">View</a>
											</div>
								...
								<div>
									<div class="product-item">
										<div class="pi-img-wrapper">
											...
											<div>
												<a
													href="${URL}assets/frontend/pages/img/products/model4.jpg"
													class="btn btn-default fancybox-button">Zoom</a> <a
													href="#product-pop-up"
													class="btn btn-default fancybox-fast-view">View</a>
											</div>
								...
								<div>
									<div class="product-item">
										<div class="pi-img-wrapper">
											...
											<div>
												<a
													href="${URL}assets/frontend/pages/img/products/model5.jpg"
													class="btn btn-default fancybox-button">Zoom</a> <a
													href="#product-pop-up"
													class="btn btn-default fancybox-fast-view">View</a>
											</div>
								...
								<div>
									<div class="product-item">
										<div class="pi-img-wrapper">
											...
											<div>
												<a
													href="${URL}assets/frontend/pages/img/products/model3.jpg"
													class="btn btn-default fancybox-button">Zoom</a> <a
													href="#product-pop-up"
													class="btn btn-default fancybox-fast-view">View</a>
											</div>
								...
								<div>
									<div class="product-item">
										<div class="pi-img-wrapper">
											...
											<div>
												<a
													href="${URL}assets/frontend/pages/img/products/model7.jpg"
													class="btn btn-default fancybox-button">Zoom</a> <a
													href="#product-pop-up"
													class="btn btn-default fancybox-fast-view">View</a>
											</div>
				...
				<div class="container">
					<div class="owl-carousel owl-carousel6-brands">
						<a href="shop-product-list.html"><img
							src="${URL}assets/frontend/pages/img/brands/canon.jpg"
